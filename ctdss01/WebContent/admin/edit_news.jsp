...
<body>
	<form action="<%=basePath%>news/edit" method="post">
		<center>
			<table width="90%" border="0" cellspacing="0" cellpadding="0" class="bg_tb" >
				<caption>公告修改界面</caption>
				<tr class="tr_title">
					<td>公告标题：</td>
					<td><input type="text" name="title" value="${news.title}" /><input type="hidden" name="id" value="${news.id}">
					</td>
				</tr>
				<tr class="tr_title">
					<td>公告类型:</td>
				...
				<tr class="tr_title">
					<td>公告来源：</td>
					<td><input type="text" name="sfrom" value="${news.sfrom}"/>
					</td>
				</tr>
				<tr class="tr_title">
					<td>公告内容：</td>

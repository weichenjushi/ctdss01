			...
			<div class="forshowfooter2">
				<div class="center_div">
					<table class="tabledownloadhelp" width=100%>
						...
						<tr>
							<td><a href="index/download/UserManualCh.jsp">下载查看《CTDSS用户手册》</a></td>
						</tr>
						<tr>
							<td><a href="index/download/UserManualCh.pdf">在线查看《CTDSS用户手册》</a></td>
						</tr>
						<tr>
							<td>
								</td>
				...
				<div style="margin-left: 20px; margin-top: 100px;">
									<p>
										<a style="font-size: 27px;">联系方式</a>
									</p>
									<p>
										<a style="font-size: 18px;">合作QQ: 1481251591</a>
									</p>
									<p>
										<a style="font-size: 18px;">合作邮箱: mrmote@qq.com</a>
									</p>
									<p>
										<a style="font-size: 18px;">QQ交流群: 168712265</a>
									</p>
									<p>
										<a style="font-size: 18px;">联系电话: 18811756877</a>
									</p>
								</div>	

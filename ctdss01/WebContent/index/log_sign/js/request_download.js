...
function submit()
{
	...
	var interest_textarea = document.getElementById("interest_textarea").value;
	...
	if(username == "" || password == "" || email == "" || firstname == "" || secondname == "" || interest_textarea == "" || describe_textarea == "" || verification_code == "")
		{
			if(username == "")
				{
			...
			else if(interest_textarea == "")
				{
					alert("interest_textarea is empty!");
				}
